  ...
  return dispatch => {
    ...
    axios
      ...
      .then(response => {
        ...
        return axios.get(
          "https://gotpool-83470.firebaseio.com/Admin/userId.json?auth=" +
            response.data.idToken
        );
      })
      .then(adminId => {
        if (adminId.data === localStorage.getItem("userId")) {
          dispatch(setAuthRedirect("/back"));
        } else {
          dispatch(setAuthRedirect("/selection"));
        }
      })
      .catch(error => {
